...
const flagshipResourceArticles: ResourceArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Clinical responsibility', body: 'Treatment options and eligibility are decided by the hospital team. Canopus should not frame one procedure as best without reviewed evidence.' },
    ],
    faqs: [
