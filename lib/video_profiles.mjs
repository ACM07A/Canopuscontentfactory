...
export const videoProfiles = {
  "knee-replacement-doctor": {
    ...
    template: "yapper-vsl-educator",
    style: "direct-to-camera UGC/VSL educator; first-frame hook; three-question ladder; licensed cutaways at one-third of runtime",
    ...
    captions: [
      ...
      "Canopus Care helps organize questions and verified information. General education, not medical advice."
    ],
    voiceover: "Considering knee replacement abroad? Start with three questions. First, what records will the hospital review before it responds? Second, what does the written estimate include, and what does it leave out? Third, how will follow-up communication work after you return home? Canopus Care helps organize questions and documented information. This is general education, not medical advice. Clinical decisions stay with qualified hospital teams."
  },
  "knee-replacement": {
    title: "Planning knee replacement abroad? Start with these questions.",
    template: "yapper-vsl-educator",
    style: "direct-to-camera UGC/VSL educator; first-frame hook; three-question ladder; licensed cutaways at one-third of runtime",
    voiceover: "Planning knee replacement abroad? Start with the questions that make an unfamiliar process clearer. Ask what records the hospital needs to review. Ask what the written estimate includes, excludes, and how long it stays valid. Ask how follow-up communication will work after you return home. Canopus Care can help organize a documented coordination pathway. This is general education, not medical advice, and clinical decisions stay with qualified hospital teams.",
